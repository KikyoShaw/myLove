...
void HeartWidget::paintEvent(QPaintEvent *event)
{
    ...
    if (angle < 30 && state == -2)
    {
        ...
        {
        case 0:
            pix.load(":/gif/qrc/gif/hh.gif");
            break;
        case 1:
            pix.load(":/gif/qrc/gif/hh1.gif");
            break;
        }
    ...
    else if (angle < 30 && state == -1)
    {
        ...
        {
        case 0:
            pix.load(":/images/qrc/images/ff.png");
            break;
        case 1:
            pix.load(":/images/qrc/images/ff1.png");
            break;
        }
        // 隔15个点取一次绘制
        if (count % 15 == 0)
    ...
    else
    {
        ...
        pix.load(":/images/qrc/images/rr1.png");
        if (state == 0)
        {
            int d = 0;
            if (resolution == 1)
        ...
        else if (state == 6)
        {
            ...
            case 0:
                ...
                pix.load(":/images/qrc/images/ll.png");
                break;
            case 1:
                pix.load(":/images/qrc/images/ll1.png");
                break;
            }
